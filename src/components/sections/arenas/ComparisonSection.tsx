...
export default function ComparisonSection({ data, language }: ComparisonSectionProps) {
  ...
  return (
    <section className="relative pt-16 pb-12 md:py-28 bg-zinc-950 overflow-hidden scroll-mt-20 border-y border-white/5">
      ...
      <div className="max-w-[1920px] mx-auto px-6 md:px-24 relative z-10">
        ...
        <div className="text-left md:text-center mb-12 md:mb-24">
          ...
          <motion.h2
            ...
            className="text-4xl md:text-6xl font-black text-white italic leading-tight uppercase"
        ...
        <div className="relative flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-0">
          ...
          {data.cards?.map((card, index) => {
            ...
            return (
              <motion.div
                key={card.id || index}
                initial={{ opacity: 0, x: isElite ? 50 : -50 }}
